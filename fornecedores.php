...
<div class="container">
    ...
    <table class="table table-success table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                <th><?php echo $fornecedores->idfornecedores ?></th>
                <th><?php echo $fornecedores->fornecedores ?></th>
                <th><?php echo $fornecedores->produto ?></th>
                <th><?php echo $fornecedores->qtdproduto ?></th>
                <th>Editar</th>
                <th>Excluir</th> 
            </tr>
            <?php } ?>
